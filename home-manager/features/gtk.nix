...

{
  gtk = {
    ...
    gtk3.extraCss = ''
      ...
      @define-color success_color #${config.colorScheme.colors.base0C};
      ...
      @define-color brown_1 #${config.colorScheme.colors.base08};
      @define-color brown_2 #${config.colorScheme.colors.base08};
      @define-color brown_3 #${config.colorScheme.colors.base08};
      @define-color brown_4 #${config.colorScheme.colors.base08};
      @define-color brown_5 #${config.colorScheme.colors.base08};
      @define-color light_1 #${config.colorScheme.colors.base05};
      @define-color light_2 #${config.colorScheme.colors.base07};
      @define-color light_3 #${config.colorScheme.colors.base06};
      @define-color light_4 #${config.colorScheme.colors.base04};
      @define-color light_5 #${config.colorScheme.colors.base02};
